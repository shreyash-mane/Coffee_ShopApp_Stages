...
**Installation Steps**   
Step 0: Download a file from https://gitlab-student.macs.hw.ac.uk/f21as-group-20/coffee-shop-group-20/-/blob/master/F21AS_Edinburgh_Group_20_Runnable_Jar.zip   
Step 1: Extract the file in the desired folder.  
Step 2: Check whether the extracted folder contain the .jar file and data folder.  
